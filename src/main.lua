...
function love.load()
    ...
    font = love.graphics.newFont("assets/Comfortaa-Regular.ttf", 12)
    mid_font = love.graphics.newFont("assets/Comfortaa-Regular.ttf", 32)
    big_font = love.graphics.newFont("assets/Comfortaa-Regular.ttf", 64)
